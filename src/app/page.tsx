...
export default function Home() {
  ...
  const [urls, setUrls] = useState(["https://www.youtube.com/embed/dQw4w9WgXcQ"]);
  ...
  return (
    <main className="relative flex flex-col h-dvh w-dvw">
      <NavBar fullScreenMode={fullScreenMode} />
      <section className="flex overflow-hidden grow items-center max-w-full">
        <SideBar fullScreenMode={fullScreenMode} theaterMode={theaterMode} />
        <motion.main className="grow max-w-full flex md:flex-row flex-col h-full">
          <PlayerContainer
          ...
          />
          <Chat chatIsHidden={chatIsHidden} setChatIsHidden={setChatIsHidden} fullScreenMode={fullScreenMode} />
        </motion.main>
      </section>
    </main>
  )
